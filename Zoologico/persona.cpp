...
{
	reconversionString(this->nombre, nombreNuevo);
	reconversionString(this->apellido, apellidoNuevo);
	this->edad = edadNuevo;
...
{
	reconversionString(nombre, nombreNuevo);
}

void persona::setApellido(string apellidoNuevo)
{
	reconversionString(apellido, apellidoNuevo);
}
